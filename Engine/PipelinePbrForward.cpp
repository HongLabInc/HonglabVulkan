...
void Pipeline::createPbrForward(VkFormat outColorFormat, VkFormat depthFormat,
                                VkSampleCountFlagBits msaaSamples)
{
    ...
    // TODO: fill vertexInputAttributes;
     ...
     * Inputs:
     * - descriptorSetLayout
     * - colorFormat and depthFormat of output attachments
     * - shaderManager_
     * - ctx_
     *
     * Outputs (member variables):
     * - pipelineLayout_
     * - pipeline_
     */
    ...
    vertexInputBindingDesc[0].stride = sizeof(Vertex);
    ...
    multisampleStateCI.rasterizationSamples = msaaSamples; // Use MSAA sample count
